   ...
   <script type="text/javascript"> 
    ...
    $("#naktifbtn").on("click",function(){
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>payment_type/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('payment_type/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
		//setting semua data dalam form dijadikan 1 variabel 
		 var formData = new FormData($('#user_form')[0]); 
                 ...
                 $.ajax({
                 url:"<?php echo base_url(); ?>payment_type/simpan_data",
                 type:"POST",
                 data:formData,
                 contentType:false,  
                 processData:false,   
       ...
       $(document).ready(function() {
		...
		$("#addmodal").on("click",function(){
            ...
            $('#example').DataTable({ 
                "ajax": "<?php echo base_url(); ?>payment_type/fetch_payment_type" 
            });
