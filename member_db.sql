...
-- ----------------------------
-- Table structure for m_group_package
-- ----------------------------
...
-- ----------------------------
-- Table structure for m_instruktur
-- ----------------------------
DROP TABLE IF EXISTS `m_instruktur`;
CREATE TABLE `m_instruktur`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `employee_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `phone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dob_place` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dob` date NULL DEFAULT NULL,
  `marital_status` enum('S','M','D') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `join_date` date NULL DEFAULT NULL,
  `no_npwp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `m_item_unit`;
CREATE TABLE `m_item_unit`  (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `m_kategori_training` VALUES (6, NULL);
...
CREATE TABLE `m_member`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `barcode_rfid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `member_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `gender` enum('P','W') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dob` date NULL DEFAULT NULL,
  `phone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `no_ktp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `register_date` date NULL DEFAULT NULL,
  `id_marketing` int NULL DEFAULT NULL,
  `status` int NULL DEFAULT NULL,
  `id_bank` int NULL DEFAULT NULL,
  `bank_account` int NULL DEFAULT NULL,
  `jenis_kartu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of m_member
-- ----------------------------
INSERT INTO `m_member` VALUES (3, '444444', 'Mr', 'Okki Setyawan', 'P', '1993-10-01', '087881724923', '3175010110930004', 'Bintara Jaya', '2022-10-10', 101, 2, 5, 5555, NULL, '14615859_1081513848635184_4183541886599049238_o - Copy.jpg', 'okkisetyawan@gmail.com', '081807917463', 'Jakarta', '17136');

-- ----------------------------
-- Table structure for m_member_group
-- ----------------------------
DROP TABLE IF EXISTS `m_member_group`;
...
-- ----------------------------
-- Table structure for m_member_type
-- ----------------------------
DROP TABLE IF EXISTS `m_member_type`;
CREATE TABLE `m_member_type`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `jenis_anggota` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `group_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
DROP TABLE IF EXISTS `m_package_service`;
...
-- ----------------------------
INSERT INTO `m_pegawai` VALUES (1, 'Okki Setyawan S.Kom', 'Bekasi Barat', '087881724923555', 'okkisetyawan@gmail.com', 'Jakarta', '2022-11-22', 'S', '2022-11-22', '827843523423', 5, '555555', '14615859_1081513848635184_4183541886599049238_o.jpg', 2, 'P');
INSERT INTO `m_pegawai` VALUES (2, 'Arif', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `m_pegawai` VALUES (3, 'Siska', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `m_pegawai` VALUES (4, 'Safa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `m_pegawai` VALUES (5, 'Dimas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `m_pegawai` VALUES (6, 'Raka', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Records of m_posisi
-- ----------------------------
INSERT INTO `m_posisi` VALUES (2, 'Admin');
INSERT INTO `m_posisi` VALUES (3, 'Sales');
INSERT INTO `m_posisi` VALUES (4, 'Kasir');

-- ----------------------------
-- Table structure for m_posisi_trainer
-- ----------------------------
DROP TABLE IF EXISTS `m_posisi_trainer`;
CREATE TABLE `m_posisi_trainer`  (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for t_pertemuan
-- ----------------------------
...
CREATE TABLE `t_pertemuan`  (
  ...
  `id_package` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `total_pertemuan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `active_pertemuan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `sisa_pertemuan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `tanggal_mulai` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `tanggal_berakhir` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
